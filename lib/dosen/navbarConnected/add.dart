        ...
        child: !dosenCheck
            ? Column(
                children: [
                  ...
                  Container(
                    padding:
                        const EdgeInsets.only(left: 18, right: 21, top: 18),
                    width: 390,
                    height: 136,
                    ...
                    child: Column(children: [
                      ...
                      const Align(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          "Please verify your email address first before continue. You only can start adding schedule after your email has been verified",
                          style: TextStyle(
                            fontFamily: 'Quicksand',
                          ),
                        ),
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ConfirmSchedule()));
